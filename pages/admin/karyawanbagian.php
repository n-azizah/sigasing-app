...
if (isset($_GET['id'])) {
   ...
   if (isset($row['id'])) {
      ...
      if (isset($_POST['button_update'])) {
         ...
         $stmt->bindParam(1, $POST['karyawan_id']);
         $stmt->bindParam(2, $POST['bagian_id']);
         $stmt->bindParam(3, $POST['tanggal_mulai']);
         if ($stmt->execute()) {
            $_SESSION['hasil'] = true;
         } else {
      ...
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active"><a href="?page=home">Riwayat Bagian</a></li>
            </ol>
         </div>
      </div>
   </div>
      ...
      <div class="card-body">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_lengkap" value="
               <?php echo $row['nama_lengkap'] ?> " disabled>
         </div>
               ...
               <tr>
                  ...
                  <td>
                     <form action method="POST">
                        ...
                        <input type="hidden" value="<?php echo $id ?>" name="karyawan_id">
                        <button type="submit" name="button_delete" class="btn btn-danger btn-sm mr-1" :
...
echo "
<meta https-equiv='refresh' content='0;url=?page=karyawanread'>";
}
}
   }