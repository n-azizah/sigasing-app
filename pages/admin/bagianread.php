         ...
         <table id="mytable" class="table table-bordered table-hover">
            ...
            <tbody>
               <?php
                    ...
                    $selectSql = "SELECT B.*, K.nama_lengkap, L.nama_lokasi FROM bagian B LEFT JOIN karyawan K ON B.karyawan_id = K.id LEFT JOIN lokasi L ON B.lokasi_id = L.id";
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <a href="?page=bagiandelete&id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm"
